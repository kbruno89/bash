...
# INTEGRA SERVIDOR OPENVPN COM MS AD OU SAMBA4 AD EM APENAS 1 CLICK !
# ELABORADO PARA DEBIAN 11 (SE VOCÊ TIVER CONHECIMENTO, COM PEQUENOS AJUSTES CONSEGUE PORTAR PARA OUTRAS DISTROS)
# BASEADO NA INSTALACAO PELO MEU TUTORIAL EM:  https://youtu.be/oJ_9RsMmBOc
...
echo ""
echo ""
echo -e " DESEJA INICIAR O PROCESSO DE INTEGRACAO COM AD NESTE SERVIDOR? [s/N]"
echo -e " DEFAULT:  s"
echo ""
read resposta
