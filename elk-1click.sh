...
echo -ne "\t VALIDANDO...\n"
ROOT=$(id -u)
VER=$(cat /etc/debian_version | grep 10 > /dev/null 2>&1)
...
[[ $MEM -lt 1950 ]] && echo -ne "\n\n     NECESSARIO NO MINIMO 2 GB DE RAM\n             SAINDO ...\n" && exit 1
...
# ESTA SENDO ATRIBUIDO 512M DE RAM PARA ALOCACAO DO JAVA
# VOCE PODE AUMENTAR ISTO DE ACORDO COM OS RECURSOS DISPONIVEIS EM SEU SERVIDOR
sed -ri 's/## -Xms4g/-Xms512m/g' /etc/elasticsearch/jvm.options
